...
Let's look at restaurants with the most violations in 10001 in 2017
...
rest_inspec %>% 
  ...
  plot_ly(y = ~dba, x = ~n, type = "bar", orientation = "h") %>% 
  layout(title = "Restuarants with most violations in 2017 in 10001",
